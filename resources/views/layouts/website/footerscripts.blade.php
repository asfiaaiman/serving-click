...
<script src="{{asset('website-assets/assets/vendor/waypoints/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('website-assets/assets/vendor/counterup/counterup.min.js')}}"></script>
